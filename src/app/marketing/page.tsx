...
// ============================================================
// CustomerPilot — World-Class Marketing Website
// Brand: Yellow + White + Black | Glassmorphism | Premium 3D feel
// ============================================================
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        >
          ...
          >
            <Button size="lg" className="bg-stone-900 text-white hover:bg-stone-800 px-8 h-14 text-base">
              Start 14-Day Free Trial
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
            <Button size="lg" variant="outline" className="px-8 h-14 text-base border-stone-300">
      ...
      <section className="py-24 bg-stone-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Bakery", "Cafe", "Restaurant", "Salon", "Gym", "Florist", "Clinic", "Spa"].map((ind, i) => (
              <motion.div
                key={i}
                ...
                className="p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10 hover:bg-white/10 transition-colors text-center"
              >
      ...
      <section className="py-24 bg-stone-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Button size="lg" className="bg-yellow-400 text-stone-900 hover:bg-yellow-300 px-8 h-14 text-base">

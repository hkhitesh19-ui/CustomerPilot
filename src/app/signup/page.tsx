...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-stone-900 font-sans relative overflow-hidden flex flex-col justify-between selection:bg-emerald-500 selection:text-stone-950">
      ...
      {/* ─── Aurora Floating Ambient Glow Background ───────────────── */}
          ...
          <div className="md:col-span-6 lg:col-span-7 flex justify-center w-full">
            <div className="w-full max-w-lg bg-white/90 border border-stone-200 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl relative">
              ...
              <div className="mb-6">
                ...
                <p className="text-stone-500 text-xs mt-1">Start your 7-day free trial in under 2 minutes</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    <Label className="text-xs font-semibold text-stone-700">Business Type</Label>
                    <Select value={form.businessType} onValueChange={v => update("businessType", v)}>
                      <SelectTrigger className="mt-1 text-xs bg-stone-50 border-stone-200 focus:bg-white"><SelectValue /></SelectTrigger>
                      <SelectContent>
                        <SelectItem value="bakery">Bakery / Cake Shop 🥐</SelectItem>
                        <SelectItem value="cafe">Cafe ☕</SelectItem>
                        <SelectItem value="restaurant">Restaurant 🍽️</SelectItem>
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-emerald-500 to-indigo-600 hover:from-emerald-600 hover:to-indigo-700 text-white font-bold text-sm py-5 shadow-lg shadow-emerald-500/20 rounded-xl mt-2"
                >
      ...
      {/* ─── Footer ────────────────────────────────────────────────── */}
      <footer className="relative z-10 border-t border-stone-200/80 bg-white/70 py-4 px-6 text-center text-xs text-stone-500">
        © 2026 CustomerPilot. Made with care in India 🇮🇳
      </footer>
    </div>
  )
}

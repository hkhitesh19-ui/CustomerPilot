...
export const metadata: Metadata = {
  ...
  description: "Comparing Bingage vs CustomerPilot? Get WhatsApp-native stamp cards, AI Google review drafts, and 1-Click AutoReply. CustomerPilot at ₹2,249/yr — purpose-built for local F&B & retail with no POS dependency.",
...
const config: VsPageConfig = {
  ...
  comparisonRows: [
    ...
    { feature: "Google Review Automation", competitor: "Add-on / Third-party", cp: "Built-in AI — no add-on needed", winner: "cp" },
